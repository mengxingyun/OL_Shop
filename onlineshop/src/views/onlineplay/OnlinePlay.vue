...
<div class="ali-player">
        <div style="margin:20px auto">
            <span style="font-size:20px;"><b>直播间号码:</b>&nbsp;&nbsp;&nbsp;</span>
            <el-input v-model="this.input" placeholder="请输入房间号" style="width:150px; font-size:20px;"></el-input>
            <el-button type="danger" plain style="margin: 20px 40px; font-size:20px;" @click="goTo(this.input)">进入</el-button>
        </div>
        <div class="main">
            <div class="video-center">
                ...
                <video id="video" controls class="video" ref="video"   style="background-color: #0c0b0b"></video>
            </div>
        </div>
    </div>
</template>
  ...
  export default {
    ...
    methods: {
        ...
        goTo(num){
            ...
            this.sourceUrls = 'http://124.70.47.219:80/hls/' + num + '/index.m3u8';
            this.playVideo();
        }
    },
    beforeUnmount () {
